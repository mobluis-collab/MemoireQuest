...
const fmt = (d: Date, m: "short" | "long" = "short") => d.toLocaleDateString("fr-FR", { day: "numeric", month: m });
  ...
  return (
    <span
      style={{
        fontSize: 11,
        fontFamily: "inherit",
        color: tw(0.3, textIntensity, isDark),
        letterSpacing: "0.5px",
      }}
    >
...
function GBorder({
  ...
  return (
    <div style={{ background: gradient, padding: "1px", borderRadius: radius, ...style }}>
      <div style={{ borderRadius: radius - 1, height: "100%", overflow: "hidden" }}>{children}</div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <text
        ...
        y={C2 + 4}
        textAnchor="middle"
        fill={tw(0.88, textIntensity, isDark)}
        fontSize="34"
        fontWeight="800"
        fontFamily={FONT}
        letterSpacing="-1.5"
...
function DotGrid({ start, deadline, accentColor }: { start: Date; deadline: Date; accentColor: string }) {
  ...
  const elapsed = today ? Math.min(daysBetween(start, today), total) : 0;
  const COLS = 55;
        ...
        <div key={r} style={{ display: "flex", gap: 2.5 }}>
          {Array.from({ length: COLS }, (_, c) => {
            ...
            return (
              <div
                key={c}
                title={fmt(addDays(start, i), "long")}
                style={{
                  width: 5,
                  height: 5,
                  borderRadius: 1.5,
...
function ChapterCard({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div
        style={{ position: "relative", display: "flex", alignItems: "center", gap: 10, width: "100%", paddingLeft: 8 }}
      >
        <span
          style={{
            fontSize: 10,
        ...
        <span
          style={{
            ...
            fontWeight: 500,
            color: done
              ? tw(0.5, textIntensity, isDark)
              : wip
                ? tw(0.85, textIntensity, isDark)
                : tw(0.65, textIntensity, isDark),
            display: "-webkit-box",
            WebkitLineClamp: 2,
    ...
    <>
      ...
      >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 16 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: tw(0.8, textIntensity, isDark) }}>
                  {ch.done}/{ch.sections}
                </span>
              </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            ...
            <div
              style={{
                fontSize: 10,
                color: tw(0.72, textIntensity, isDark),
                fontWeight: 700,
                textTransform: "uppercase",
                letterSpacing: "1px",
              }}
            ...
            <div style={{ fontSize: 10, color: tw(0.55, textIntensity, isDark) }}>Clique sur ✓ pour décocher</div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            {ch.sectionList.map((sec, i) => {
              const isDone = isSectionDone(chapterProgress[String(i)]);
              const isNext =
                !isDone && ch.sectionList.slice(0, i).every((_, j) => isSectionDone(chapterProgress[String(j)]));
              ...
              return (
                <div
                  key={i}
                  onClick={() => {
                    if (isClickable && !isLoading) onSectionComplete(i);
                  }}
                  style={{
                    display: "flex",
                    alignItems: "center",
                ...
                >
                  <div
                    style={{
                      ...
                      alignItems: "center",
                      justifyContent: "center",
                      background: isDone ? bg(0.12, isDark) : isNext ? bg(0.1, isDark) : bg(0.05, isDark),
                      border: `1.5px solid ${isDone ? bg(0.3, isDark) : isNext ? bg(0.25, isDark) : bg(0.1, isDark)}`,
                      fontSize: 10,
                      fontWeight: 800,
                      boxShadow: "none",
                      transition: "all 0.15s cubic-bezier(.4,0,.2,1)",
                  ...
                  <div style={{ flex: 1 }}>
                    <div
                      style={{
                        ...
                        color: isDone
                          ? tw(0.65, textIntensity, isDark)
                          : isNext
                            ? tw(0.95, textIntensity, isDark)
                            : tw(0.72, textIntensity, isDark),
                      }}
                    >
                      {sec.text}
                    </div>
                    {isNext && (
                      <div
                        style={{ fontSize: 10, color: tw(0.45, textIntensity, isDark), marginTop: 2, fontWeight: 500 }}
                      >
                        Cliquer pour valider
                      </div>
                    )}
                    {isDone && (
                      <div style={{ fontSize: 10, color: tw(0.3, textIntensity, isDark), marginTop: 2 }}>
        ...
        <div style={{ padding: "16px 20px", borderTop: "1px solid var(--mq-border)", flexShrink: 0 }}>
          <div style={{ fontSize: 11, color: tw(0.6, textIntensity, isDark), textAlign: "center" }}>
...
function ReuploadOverlay({
  ...
  useEffect(() => {
    ...
    const timers = delays.map((delay, i) => setTimeout(() => setStepIndex(i), delay));
    ...
    >
      <div
        style={{
          ...
          border: `1px solid ${bg(0.1, isDark)}`,
          display: "flex",
          flexDirection: "column",
          alignItems: "center",
          gap: 24,
      ...
      >
        ...
        <div
          style={{
            ...
            height: 40,
            borderRadius: "50%",
            border: `2.5px solid ${bg(0.1, isDark)}`,
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 12, color: "var(--mq-text-muted)" }}>Régénération du plan avec conseils…</div>
        </div>
        ...
        <div style={{ width: "100%" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, color: tw(0.75, textIntensity, isDark) }}>
              {current.pct}%
            </span>
          </div>
          <div
        ...
        <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 6 }}>
          {REUPLOAD_STEPS.slice(0, stepIndex).map((s) => (
            ...
            >
              <span style={{ color: tw(0.5, textIntensity, isDark), fontSize: 10 }}>✓</span>
              {s.label}
            </div>
          ))}
        </div>
...
function OnboardingScreen({
  ...
  return (
    ...
    >
      ...
      >
        Importe ton cahier des charges.
      </h1>
      <p
        style={{
          fontSize: 16,
...
export default function NewDashboard({
  ...
  const levelTitle =
    currentLevel <= 2 ? "Étudiant" : currentLevel <= 4 ? "Chercheur Jr." : currentLevel <= 7 ? "Chercheur" : "Expert";
  ...
  useEffect(() => {
    ...
    if (prev.length > 0 && chapters.length > 0) {
      const justCompleted = chapters.find((ch) => {
        ...
        return prevCh && prevCh.done < prevCh.sections && ch.done === ch.sections && ch.sections > 0;
      });
  ...
  return (
    ...
    >
      ...
      <aside
        style={{
          width: focusMode ? 0 : sidebarCollapsed ? 56 : 216,
          flexShrink: 0,
          height: "100vh",
          position: "relative",
          zIndex: 10,
          ...
          transition:
            "width 0.35s cubic-bezier(.4,0,.2,1), border-right 0.35s cubic-bezier(.4,0,.2,1), opacity 0.35s cubic-bezier(.4,0,.2,1)",
          overflow: "hidden",
      ...
      >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                color: tw(0.8, textIntensity, isDark),
                fontSize: 13,
                fontWeight: 800,
            ...
            {!sidebarCollapsed && (
              <div>
                ...
                {/* FIX: was 0.25 → 0.5 */}
                <div style={{ fontSize: 10, color: tw(0.5, textIntensity, isDark), letterSpacing: "0.3px" }}>
                  Thesis OS v1.0
                </div>
              </div>
            )}
        ...
        <div
          style={{
            padding: sidebarCollapsed ? "14px 0 12px" : "14px 14px 12px",
            borderBottom: "1px solid var(--mq-card-hover)",
            display: "flex",
            flexDirection: "column",
        ...
        >
          <div
            style={{
              ...
              alignItems: "center",
              gap: 10,
              marginBottom: sidebarCollapsed ? 0 : 10,
          ...
          >
            <div
              style={{
                ...
                justifyContent: "center",
                color: tw(0.8, textIntensity, isDark),
                fontSize: sidebarCollapsed ? 11 : 14,
                fontWeight: 800,
          ...
          {!sidebarCollapsed && (
            <>
              ...
              <div style={{ fontSize: 9, color: tw(0.35, textIntensity, isDark) }}>
                {totalPoints} XP
                {levelInfo.isMaxLevel ? "" : ` \u00B7 encore ${xpToNext} avant le niv. ${currentLevel + 1}`}
              </div>
            </>
          )}
        </div>
        ...
        <nav style={{ flex: 1, padding: "8px 7px" }}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: active ? tw(0.9, textIntensity, isDark) : tw(0.45, textIntensity, isDark),
                  fontSize: 13,
              ...
              >
                <span
                  style={{
                    ...
                    width: 20,
                    textAlign: "center",
                    color: active ? tw(0.6, textIntensity, isDark) : tw(0.25, textIntensity, isDark),
          ...
          <button
            ...
            style={{
              ...
              color: showIntensity ? tw(0.9, textIntensity, isDark) : tw(0.45, textIntensity, isDark),
              fontSize: 13,
              fontWeight: showIntensity ? 600 : 400,
          ...
          >
            <span
              style={{
                ...
                width: 20,
                textAlign: "center",
                color: showIntensity ? tw(0.6, textIntensity, isDark) : tw(0.25, textIntensity, isDark),
                transition: "color 0.3s cubic-bezier(.4,0,.2,1)",
              }}
            >
              {"\u25D0"}
            ...
            >
              <div style={{ padding: "6px 13px 10px" }}>
                ...
                >
                  ...
                  <span style={{ fontSize: 10, color: tw(0.5, textIntensity, isDark), fontWeight: 600 }}>
                    {Math.round(textIntensity * 100)}%
                  </span>
                </div>
                <style>{`
                .mq-intensity-slider {
        ...
        <div
          style={{
            padding: "8px 7px",
            borderTop: "1px solid var(--mq-card-hover)",
            display: "flex",
            flexDirection: "column",
            gap: 1,
          }}
        >
          {!sidebarCollapsed && plan && (
            <>
              ...
              >
                <span style={{ fontSize: 11, color: tw(0.25, textIntensity, isDark) }}>{"\u2191"}</span>{" "}
                {isLoading ? "Analyse en cours\u2026" : "R\u00E9-importer un PDF"}
              </button>
            </>
          )}
          {/* Theme toggle */}
      ...
      {!focusMode && (
        <button
          ...
          style={{
            ...
            boxShadow: `0 1px 4px ${bg(0.1, isDark)}`,
          }}
        >
          {"\u2039"}
        </button>
          ...
          >
            ...
            {activeView !== "dashboard" && (
              <div style={{ flex: 1, minHeight: 0, overflow: "auto" }}>
                  ...
                  <MemoireView
                    ...
                    questProgress={Object.fromEntries(
                      Object.entries(questProgress).map(([k, v]) => [
                        k,
                        Object.fromEntries(Object.entries(v).map(([ik, iv]) => [String(ik), iv])),
                      ])
                    )}
                ...
                {activeView === "notes" && (
                  <NotesView textIntensity={textIntensity} isDark={isDark} onCountChange={setNotesCount} />
                )}
              </div>
            )}
            ...
            {activeView === "dashboard" && (
              <>
                ...
                >
                  ...
                  >
                    <span style={{ fontSize: 14, fontWeight: 700, color: tw(0.45, textIntensity, isDark) }}>
                      {streak.current}
                    </span>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {deadlineDate ? (
                          ...
                          <div>
                            ...
                            <div style={{ display: "flex", alignItems: "flex-end", gap: 10, marginBottom: 6 }}>
                              ...
                              <div style={{ paddingBottom: 8 }}>
                                <div style={{ fontSize: 16, color: tw(0.65, textIntensity, isDark), fontWeight: 500 }}>
                                  jours
                                </div>
                                <div style={{ fontSize: 11, color: tw(0.5, textIntensity, isDark) }}>
                                  {"\u2248"} {Math.round(remaining / 7)} semaines
                                </div>
                              </div>
                            </div>
                            <div
                              style={{ fontSize: 11, color: tw(0.5, textIntensity, isDark), letterSpacing: "0.2px" }}
                            >
                              Deadline {"\u00B7"}{" "}
                              <span style={{ color: tw(0.8, textIntensity, isDark), fontWeight: 600 }}>
                                {fmt(deadlineDate, "long")} {deadlineDate.getFullYear()}
                              </span>
                            </div>
                          </div>
                        ...
                        >
                          <div style={{ fontSize: 28, color: tw(0.15, textIntensity, isDark) }}>{"\u2014"}</div>
                          <div
                            style={{
                              fontSize: 12,
                              color: tw(0.45, textIntensity, isDark),
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        {[
                          ...
                          {
                            label: "En cours",
                            val: `${chapters.filter((c) => c.done > 0 && c.done < c.sections).length} chap.`,
                          },
                        ].map((s) => (
                          <div key={s.label} style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 9 }}>
                            <span style={{ fontSize: 11.5, color: tw(0.5, textIntensity, isDark) }}>{s.label}</span>
                            <div
                              style={{ flex: 1, borderBottom: "1px dashed var(--mq-stroke-soft)", marginBottom: 2 }}
                            />
                            <span style={{ fontSize: 11.5, fontWeight: 600, color: tw(0.8, textIntensity, isDark) }}>
                              {s.val}
                            </span>
                          </div>
                        ))}
                    ...
                    >
                      {[
                        ...
                        },
                        {
                          ...
                          sub: levelInfo.isMaxLevel
                            ? "Niveau max"
                            : `encore ${xpToNext} avant le niv. ${currentLevel + 1}`,
                        },
                        {
                          label: "Régularité",
                  ...
                  <div style={{ gridColumn: "1 / 3", display: "flex", flexDirection: "column", gap: 7, minHeight: 0 }}>
                    ...
                    >
                      ...
                      <div style={{ fontSize: 10, color: tw(0.6, textIntensity, isDark) }}>
          ...
          >
            <div
              style={{
                ...
                borderTopColor: tw(0.4, textIntensity, isDark),
                animation: "mq-spin 0.8s linear infinite",
              }}
            />
            <div style={{ fontSize: 14, color: tw(0.5, textIntensity, isDark), fontWeight: 500 }}>
              G{"\u00e9"}n{"\u00e9"}ration du plan en cours...
            </div>
            <div style={{ fontSize: 12, color: tw(0.25, textIntensity, isDark) }}>
              L{"\u0027"}IA utilise tes m{"\u00e9"}tadonn{"\u00e9"}es v{"\u00e9"}rifi{"\u00e9"}es pour cr{"\u00e9"}er un
              plan sur mesure.
            </div>
          </div>
            ...
            {chapters.map((chapter, ci) =>
              chapter.sectionList.map((section, si) => (
                <button
                  ...
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLButtonElement).style.background = bg(0.04, isDark);
                  }}
                >
                  <div style={{ fontSize: 10, color: tw(0.3, textIntensity, isDark), marginBottom: 4 }}>
                    {chapter.num} — {chapter.title}
                  </div>
                  <div style={{ fontWeight: 500 }}>{section.text}</div>
                </button>
              ))
            )}
          </div>
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ fontSize: 12, color: tw(0.5, textIntensity, isDark) }}>
              ...
              >
                <div style={{ maxWidth: 640, width: "100%" }}>
                  ...
                  <div style={{ marginTop: 8, marginBottom: 20 }}>
                    ...
                    >
                      {focusSec.difficulty === "hard"
                        ? "Difficile"
                        : focusSec.difficulty === "medium"
                          ? "Moyen"
                          : "Facile"}
                    </span>
                  </div>
                  ...
                  {focusChapter.tips && (
                    <div
                      style={{
                        padding: "14px 18px",
                        borderRadius: 10,
                        borderLeft: `3px solid ${bg(0.1, isDark)}`,
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              color: tw(isComplete ? 0.35 : 0.7, textIntensity, isDark),
                              fontSize: 14,
                              cursor: isTaskLoading ? "default" : "pointer",
                              transition: "all 0.15s",
                          ...
                          >
                            <div
                              style={{
                                ...
                                background: isComplete ? bg(0.7, isDark) : "transparent",
                                fontSize: 11,
                              }}
                            >
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {[
                ...
                >
                  <span style={{ fontSize: 13, color: tw(0.65, textIntensity, isDark) }}>{shortcut.desc}</span>
            ...
            >
              ...
              <kbd
                style={{
                  ...
                  fontSize: 11,
                  fontWeight: 600,
                  color: tw(0.6, textIntensity, isDark),
                }}
              >
                ?
              </kbd>{" "}
