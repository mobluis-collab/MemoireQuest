...
export default function ProgressionView({
  ...
  const drawGame = useCallback(
    (ctx: CanvasRenderingContext2D, g: NonNullable<typeof gameRef.current>) => {
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "center", padding: "8px 6px" }}>
            ...
            <div style={{ fontSize: 26, fontWeight: 800, color: "var(--mq-text-primary)", letterSpacing: "-1px" }}>
              {globalPct}%
            </div>
            <div style={{ fontSize: 10, color: tw(0.35, textIntensity, isDark), marginTop: 2 }}>
              {doneSec}/{totalSec} sections
            </div>
          </div>
          {/* Temps */}
          <div style={{ textAlign: "center", padding: "8px 6px" }}>
            ...
            <div style={{ fontSize: 10, color: tw(0.35, textIntensity, isDark), marginTop: 2 }}>
              {hasDeadline ? `${remaining} jours restants` : "Aucune deadline"}
            </div>
          </div>
          {/* Points */}
          <div style={{ textAlign: "center", padding: "8px 6px" }}>
            ...
            {waitingToStart && (
              ...
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path d="M3 1.5L12 7L3 12.5V1.5Z" fill={tw(0.5, textIntensity, isDark)} />
                </svg>
              </button>
            )}
            ...
            {chapters.map((ch) => {
              ...
              return (
                <div
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLDivElement).style.background = bg(0.04, isDark);
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  <div
                    style={{ flex: 1, height: 4, borderRadius: 99, background: bg(0.06, isDark), overflow: "hidden" }}
                  >
                    <div
                      style={{
                        height: "100%",
                  ...
                  >
                    <div
                      style={{
                        ...
                        aspectRatio: "1",
                        borderRadius: 4,
                        background: active ? (isToday ? bg(0.15, isDark) : bg(0.08, isDark)) : bg(0.04, isDark),
                        border: `1px solid ${active ? bg(0.1, isDark) : "var(--mq-stroke-soft)"}`,
                      }}
                    />
                    <span style={{ fontSize: 8, color: tw(0.3, textIntensity, isDark), fontWeight: 500 }}>
                      {today ? ["L", "M", "M", "J", "V", "S", "D"][(today.getDay() + i - 6 + 7) % 7] : "·"}
                    </span>
                  </div>
                );
              })}
            </div>
            <div style={{ fontSize: 10, color: tw(0.5, textIntensity, isDark) }}>
              {streak.current === 0
            ...
            {[
              ...
              <div key={d.label} style={{ marginBottom: 8 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 3 }}>
                  <span style={{ fontSize: 10, color: tw(0.5, textIntensity, isDark) }}>{d.label}</span>
                  <span style={{ fontSize: 10, fontWeight: 600, color: tw(0.6, textIntensity, isDark) }}>
                    {d.total}
                  </span>
                </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {selectedCh.sectionList.map((sec, idx) => {
                ...
                const diffColors: Record<string, string> = {
                  easy: tw(0.35, textIntensity, isDark),
                  medium: tw(0.45, textIntensity, isDark),
                  hard: tw(0.55, textIntensity, isDark),
                };
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: 18,
                        borderRadius: 4,
                        border: `1.5px solid ${isDone ? tw(0.3, textIntensity, isDark) : bg(0.12, isDark)}`,
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        fontSize: 10,
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div
                        style={{
                          fontSize: 11,
                          fontWeight: 500,
                          color: isDone ? tw(0.4, textIntensity, isDark) : tw(0.75, textIntensity, isDark),
